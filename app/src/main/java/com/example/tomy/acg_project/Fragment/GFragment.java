...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout=(SwipeRefreshLayout)view.findViewById(R.id.g_swipe_refresh_layout);
        rv = (RecyclerView) view.findViewById(R.id.g_recycler_view);
        ...
        //获取数据进行填充
        new GetArticle().getArticle(3,start);
        //设置Item点击监听
