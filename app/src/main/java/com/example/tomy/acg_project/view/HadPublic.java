 ...
 */
public class HadPublic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取数据进行填充
        new GetArticle().getPublicArticle(Domain.getUserId(),start);
        //设置Item点击监听
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemLongClick(View view) {
                ...
                Domain.setArticleResponse(article.get(rv.getChildAdapterPosition(view)));
                //显示对话框
                new ShowDeleteWindows(HadPublic.this).showIfDelete();
            }
